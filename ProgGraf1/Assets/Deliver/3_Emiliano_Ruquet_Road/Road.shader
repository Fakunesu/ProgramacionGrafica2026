...
Shader "Road"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v )
		{
			...
			float simplePerlin2D27 = snoise( tex2Dlod( _HeigtMap, float4( uv_HeigtMap, 0, 0.0) ).rg*0.0 );
			simplePerlin2D27 = simplePerlin2D27*0.5 + 0.5;
			float3 clampResult26 = clamp( ( simplePerlin2D27 * float3(0,1,0) * _HeigtScale ) , float3( 0,0,0 ) , float3( 0,1,0 ) );
			v.vertex.xyz += clampResult26;
			v.vertex.w = 1;
		}
...
/*ASEBEGIN
Version=18900
360;73;1235;645;362.5625;398.976;1.579951;True;False
...
Node;AmplifyShaderEditor.NoiseGeneratorNode;27;481.2406,157.512;Inherit;False;Simplex2D;True;False;2;0;FLOAT2;0,0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;18;691.1451,192.5159;Inherit;False;3;3;0;FLOAT;0;False;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.ClampOpNode;26;935.0629,130.9115;Inherit;False;3;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,1,0;False;1;FLOAT3;0
...
ASEEND*/
//CHKSM=517D6E3D1475C25AC89BF17E0AD28C146DC2D8A8