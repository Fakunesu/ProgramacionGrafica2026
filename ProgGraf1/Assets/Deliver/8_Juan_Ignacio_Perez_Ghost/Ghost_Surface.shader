...
Shader "Ghost_Surface"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float4 tex2DNode13 = tex2D( _Cuerpo, ( float4( ( i.uv_texcoord * _Cuts ), 0.0 , 0.0 ) + appendResult8 ).xy );
			o.Albedo = ( Face12 + tex2DNode13 ).rgb;
...
/*ASEBEGIN
Version=18900
363;73;1101;535;4194.061;1410.224;4.169718;True;False
...
Node;AmplifyShaderEditor.CommentaryNode;23;-1750.195,-196.286;Inherit;False;440.7686;353.7639;Multiplicar textura en un eje;3;10;3;4;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.Vector2Node;3;-1632.05,15.71177;Inherit;False;Property;_Cuts;Cuts;1;0;Create;True;0;0;0;False;0;False;6,1;10,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.OneMinusNode;6;-1369.295,-494.4261;Inherit;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;4;-1694.049,-125.2883;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;10;-1444.071,-54.37859;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;19;-356.7728,-219.1719;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=7E630898EB3DB887CD8E8903D75E7AA8EC980FFB